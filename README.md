...
| <a name="input_node_provisioning_mode"></a> [node\_provisioning\_mode](#input\_node\_provisioning\_mode) | The node provisioning mode for the AKS cluster. Possible values are `Auto` and `Manual`. | `string` | `"Manual"` | no |
